...
我们提供覆盖抖音、微信生态的全场景数据接口，支持按需定制与高并发调用。
...
| 接口名称 | 核心功能 |
| -------- | -------- |
| 抖音视频详情 | 采集抖音视频全量数据：标题、封面、时长、发布时间、点赞/评论/转发/收藏数据、作者信息、视频播放链接等 |
| 抖音用户信息 | 获取抖音用户主页信息：昵称、头像、简介、粉丝数、关注数、作品数、获赞数等账号基础数据 |
| 抖音用户发文列表 | 批量获取指定抖音账号发布的作品列表，支持分页、按时间范围抓取，返回作品基础信息与互动数据 |
| 抖音视频一级评论 | 抓取视频下一级评论内容、评论用户信息、评论时间、评论点赞数、评论ID等结构化数据 |
| 抖音视频二级评论 | 深度采集一级评论下的回复（二级评论），完整还原评论层级关系、回复内容、互动数据 |
| 抖音关键词搜索 | 支持按关键词、话题、筛选条件搜索抖音视频，返回搜索结果列表、视频基础信息、互动数据及作者信息，支持分页与结果排序 |
